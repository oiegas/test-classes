...
<body>
	...
	<div id="bg">
		...
		<div class="module">
			<ul>
				<li class="tab activeTab"><img
					src="http://i.imgur.com/Fk1Urva.png" alt="" class="icon" /></li>
			</ul>
			<ul>
			<li class="tab"><img src="http://i.imgur.com/ZsRgIDD.png" alt=""
				onclick="location.href='startup'" class="icon" /></li>
			...
			<form:form action="${add}" commandName="class"
			...
			<c:if test="${!empty listClasses}">
				<table class="tg">
					...
					<c:forEach items="${listClasses}" var="class">
						<tr>
							<td>${class.classId}</td>
							<td>${class.className}</td>
							
							<%-- <td><a class="button"
								href="<c:url value='/class/remove/${class.classId}' />"
